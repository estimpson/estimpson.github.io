...
const vsSource = `#version 300 es
        ...
        void main() {
            ...
            vertexColor = vec4(0.5, 0.0, 0.0, 1.0); // set output value to desired color
        }
    `;
...
const fsSource = `#version 300 es
        ...
        out vec4 FragColor;
        in vec4 vertexColor; // same name and type as vertex shader output allows the value to be passed in
