...
const vsSource = `#version 300 es
        ...
        void main() {
            ...
            position = translation + aPos;  // pass to fragment shader
        }
    `;
...
const fsSource = `#version 300 es
        ...
        void main() {
            FragColor = vec4(position, 1.0); // use position xyz passed in as rgb and set alpha channel to 1.0
        }
    `;
...
class WebGLExperiment {
    ...
    drawScene(gl, programInfo, vao) {
        ...
        gl.uniform3f(translationUniformLocation, 0.0, 0.0, 0.0);
